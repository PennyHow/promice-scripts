...
ax.set_yticklabels(['0', '10.000', '20.000', '30.000', '40.000', '50.000', '60.000'], fontsize=fsize3, color=fcol)
...
ax1.set_yticklabels(['','', '0', '100.000', '200.000', '300.000', '400.000'], fontsize=fsize3, color=fcol)
...
ax.set_title('AWS Dataverse downloads by month', fontsize=fsize1, color=fcol, pad=20)
